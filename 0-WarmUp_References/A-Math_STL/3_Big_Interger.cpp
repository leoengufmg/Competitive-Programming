...
Note: there is a BOOSR C++ library which allows us to work with big intergers as well.
...
void multiply(int *a, int &n, int no)
{
	...
	// goingg to store in reverse order=> 4 * 321 = {4, 8, 2, 1}
	for (int i = 0; i < n; i++)
	{
...
void big_factorial(int number){
	...
	// fatorial start by 1
	a[0] = 1;
	// which denotes the index of the array, till which we have stored some digits. If 24, n = 2, because ocuppy 2 digits
	int n = 1; 
